...
def generate_report_with_gemini(case_data: Dict) -> Optional[Dict]:
    ...
    try:
        ...
        return {
            ...
            "disclaimer": (
                "This report is generated by AI for investigation support only. "
                "All findings require human review. "
                "Synthetic data — not real financial data."
            ),
        }
...
"""
    ...
    return {
        "case_id": case_id,
        "risk_band": risk_band,
        "executive_summary": f"Account {account_id} flagged with priority score {score}/100 [{risk_band}]. Multiple signals elevated. Human review required.",
        "key_findings": [
        ...
        "disclaimer": (
            "This report is generated for investigation support only. "
            "All findings require human review. Synthetic data — not real financial data."
        ),
    }
